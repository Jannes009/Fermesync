...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleProductSelection(value, selectElement) {
        ...
        try {
            const response = await fetch("/market/get-last-sales-price", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    stockLink: stockLink,
    ...
    openStockFormBtn.addEventListener("click", () => {
        window.location.href = "/market/maintanance/create-product";
    });
    ...
    $("form").on("submit", function (e) {
        ...
        fetch("/market/api/clear-saved-form", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    productTable.on("click", ".delete-row-btn", async function () {
        ...
        try {
            const response = await fetch('/market/delete-row', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
function check_delivery_note(){
    ...
    fetch('/market/check_delivery_note', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
