...
function fetchImportedData() {
    ...
    fetch("/market/import/get_imported_results")
...
;
    ...
    function discardConsignment(consignmentId) {
        fetch('/market/import/discard_consignment', {
            method: "POST",
            headers: {
...
function updateMarketDelNoteNo(oldDelNoteNo, newDelNoteNo) {
    ...
    return fetch("/market/import/update_market_del_note_no", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
function toggleDocketDetails(button, consignmentId) {
    ...
    fetch(`/market/import/get_dockets?consignment_id=${encodeURIComponent(consignmentId)}`)
        .then(response => response.json())
        .then(dockets => {
...
function showConsignmentDetails(consignmentId) {
    fetch(`/market/import/get_consignment_details?consignment_id=${consignmentId}`)
        .then(response => response.json())
        .then(data => {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('/market/import/match_consignment', { 
                        method: "POST",
                        headers: {
                            'Content-Type': 'application/json',
                        },
