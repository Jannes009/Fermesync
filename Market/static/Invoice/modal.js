...
async function fetchProducts() {
    ...
    try {
        ...
        const response = await fetch(`/market/entry/details/${deliveryNoteId}`);
...
function check_invoice_number(){
    ...
    async function fetchDeliveryNoteId(DelNoteNo) {
        ...
        try {
            ...
            const response = await fetch("/market/get_delivery_note_id", {
