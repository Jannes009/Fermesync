...
@market_bp.route('/delivery-note-report')
def delivery_note_report():
    return render_template(
        'Reports/reports.html'
    )

@market_bp.route('/delivery-note-report-template')
...
@market_bp.route('/api/fetch-delivery-note-report', methods=['GET'])
...
@market_bp.route("/save_template", methods=["POST"])
def save_template():
